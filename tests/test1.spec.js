...
test("Test Case 1: Register User", async ({ page }) => {
  ...
  await expect(page.locator('#form')).toContainText('You can create new account to take advantage of member privileges to enhance your online shopping experience with us.');
  await page.getByRole('link', { name: 'Continue' }).click();
});
